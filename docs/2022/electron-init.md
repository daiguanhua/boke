...
入选 csdn 热榜第八嘿嘿<br>
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init1.png)
...
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init2.png)

### 1.3 创建完毕后测试一下

![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init3.png)
...
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init4.png)
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init5.png)
...
这里我选择的是目前最新版 13.0.0
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init6.png)
...
看到这里就已经成功咯~
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init7.png)

### 5.3 注释掉 DevTools 检测

如果应用没安装 devTools 会自动安装，但是又慢又卡，直接在 `background.js` 注释掉
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init8.png)
...
打开康康：
![electron](https://gitee.com/dai-guanhua/pic-go/raw/master/img/2022/electron-init/electron-init9.png)
